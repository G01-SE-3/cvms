...
import 'package:cvms/presentation/screens/navigation_bars/GeneralAppBar.dart';  // Make sure to import the custom GeneralAppBar if needed
import 'package:cvms/presentation/screens/navigation_bars/sidebar.dart';  // If you have a sidebar
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const PreferredSize(
        ...
        child: GeneralAppBar(search: true,initialTabIndex: 3,  PageName: 'IO'),
      ),
      body: Container(
