                ...
                return FutureBuilder<List<BusinessOffender>>(
                  ...
                  builder: (context, businessOffenderSnapshot) {
                    if (inspectorSnapshot.connectionState ==
                      ...
                      return Center(
                        child: Text(
                          'Error: ${inspectorSnapshot.error ?? businessOffenderSnapshot.error}',
                        ),
                      );
                    } else {
                      ...
                      return Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              StatCard('Total PVs', totalPVs.toString(),
                              ...
                              StatCard(
                                  ...
                                  Colors.green),
                              StatCard('Inspectors',
                                  totalInspectors.toString(), Icons.person, Colors.orange),
                            ],
                          ),
                          const SizedBox(height: 30),
                          LineChartWidget(title: 'Monthly PVs Evolution'),
                        ],
                      );
                    }
                  },
